						...
						<template v-if="slice.primary.link && slice.primary.link.length">
							<div class="left-section-links">
								...
								>
									...
									<svg
										v-if="linkItem.variant === 'Linkedin'"
										class="link-icon linkedin-icon"
									...
									<!-- Newsletter/Email Icon - Nice Orange #FF6719 -->
									<svg
										v-else-if="linkItem.variant === 'Newsletter'"
										class="link-icon newsletter-icon"
										xmlns="http://www.w3.org/2000/svg"
										width="24"
										height="24"
										viewBox="0 0 24 24"
									...
									<!-- Substack Icon - Brand Orange #FF6719 -->
									<svg
										v-else-if="linkItem.variant === 'Substack'"
										class="link-icon substack-icon"
										xmlns="http://www.w3.org/2000/svg"
										width="24"
										height="24"
										viewBox="0 0 24 24"
