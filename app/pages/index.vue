...
const { data: page, error } = await useAsyncData(`home-page-${locale.value}`, () =>
...
// Set page title
const pageTitle = page.value?.data?.meta_title || 'Home'
  ...
  <div class="page-wrapper">
    ...
    <div v-else-if="page" class="page-layout">
      <aside class="page-layout__left">
        ...
        <template v-for="(slice, index) in page.data.slices" :key="slice.id || index">
          <div v-if="slice.slice_type === 'section'" class="left-section-content">
            <!-- Image -->
            <PrismicImage
            ...
            <template v-if="slice.primary.link && slice.primary.link.length">
              <div class="left-section-links">
                ...
                >
                  ...
                  <svg v-if="linkItem.variant === 'Linkedin'" class="link-icon linkedin-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#0A66C2">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                  </svg>

                  <!-- Website Icon - Keep current color -->
                  <svg v-else-if="linkItem.variant === 'Website'" class="link-icon website-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <main class="page-layout__right">
        ...
        <SliceZone
          :slices="(page.data.slices ?? []).filter(slice => slice.slice_type !== 'section')"
